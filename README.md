...
API development and Railway deploy using **FastAPI framework** and data extraction from **SQLite** local hosted database.
...
For deployment in Railway, the explicit requirements were established in requirements.txt. Procfile configuration in the Procfile file, and version of python to be used is specified in runtime.txt. Once the mandatory files are structured, the deployment is done in Railway dashboard.
...
[Railway Deploy Link](https://web-production-621f.up.railway.app/docs)
